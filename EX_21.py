...
Слова необхідно шукати у всіх регістрах. Тобто. якщо необхідно знайти слово "one", значить для нього будуть підходити
...
def popular_words(text, words):
    ...
    numbers = [lower_text.count(i) for i in words]
    res = dict()
    for i in range(len(words)):
        res[words[i]] = numbers[i]
    return res
